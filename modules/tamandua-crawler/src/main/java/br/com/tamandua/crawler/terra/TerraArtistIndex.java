...
import br.com.tamandua.crawler.letras.AZLetrasParser;
import br.com.tamandua.crawler.parser.TrackReport;

/**
 * Class TerraArtistIndex
 *
 * @author Everton Rosario (erosario@gmail.com)
 */
public class TerraArtistIndex implements IProviderArtistIndex {
    private static final String PROVIDER = "terra";
    ...
    public ArtistList crawlLetter(String letter, CrawlerHTTP http) throws IOException {
        ...
        String responseBody = http.getResponseBody("/letra/"+letter.toUpperCase()+"/");
        AZTerraParser parser = new AZTerraParser(responseBody);
    ...
    public int crawlAllArtistLetters(String indicatedLettersToCrawl, CrawlerHTTP http) throws JAXBException, IOException {
        ...
        System.out.println("terra.crawlAllLetters took ["+((end - start)/1000)+"] seconds.");
        return totalArtists;
    }
    ...
    public ArtistList summarizeLetters(String type) throws JAXBException {
        ...
        long end = System.currentTimeMillis();
        System.out.println("terra.summarizeLetters took ["+(end - start)+"] miliseconds.");
        return fullList;
    }
    ...
    public ArtistList loadSummarizedLetters(String lettersToUse, String type) throws JAXBException {
        ...
        long end = System.currentTimeMillis();
        System.out.println("terra.loadSummarizedLetters took ["+(end - start)+"] miliseconds.");
        return artistList;
    }
    ...
    public void crawlTracksIndexFromArtists(ArtistList artistList) throws JAXBException, IOException, InterruptedException {
    	...
    	long end = System.currentTimeMillis();
    	System.out.println("terra.crawlTracksIndexFromArtists took ["+(end - start)+"] miliseconds.");
	...
	public TrackReport crawlTrackContents(ArtistList fullArtistList, int numberThreads, String type) throws JAXBException, InterruptedException {
		...
		long end = System.currentTimeMillis();
		System.out.println("LetrasArtistIndex.crawlTrackContents took [" + (end - start) + "] milliseconds.");
		return report;
	}
    ...
    public TrackReport countTracks(ArtistList fullArtistList, int numberThreads, String type) throws JAXBException, InterruptedException {
        ...
        long end = System.currentTimeMillis();
        System.out.println("TerraArtistIndex.countTracks took [" + (end - start) + "] milliseconds.");
        return report;
    }
