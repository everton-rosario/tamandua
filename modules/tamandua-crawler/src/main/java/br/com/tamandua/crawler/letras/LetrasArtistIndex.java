...
/**
 * Class LetrasArtistIndex
 *
 * @author Everton Rosario (erosario@gmail.com)
 */
public class LetrasArtistIndex implements IProviderArtistIndex {
    private static final String PROVIDER = "letras";
    ...
    public ArtistList crawlLetter(String letter, CrawlerHTTP http) throws IOException {
        ...
        String responseBody = http.getResponseBody("/letra/"+letter.toLowerCase()+"/");
        AZLetrasParser parser = new AZLetrasParser(responseBody);
    ...
    public ArtistList loadSummarizedLetters(String lettersToUse, String type) throws JAXBException {
        ...
        // Caso contrario realiza a leitura de cada uma das letras informadas e as carrega em memoria
            ...
            for (int i = 0; i < lettersToUse.length(); i++) {
                ArtistList letterList = IOIndex.readLetter(getLetter(lettersToUse.charAt(i)), PROVIDER);
